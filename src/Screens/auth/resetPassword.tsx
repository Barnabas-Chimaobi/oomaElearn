      ...
      <WingBlank>
        ...
        <View>
          <Text style={style.enterVerification}>
            Enter the OTP that was sent to you and input new password{' '}
          </Text>
        </View>
        {/* <Text style={style.enterCode}>
          Enter the 6-digit code sent to +234 000 0000
        </Text> */}
        <Input placeholder="Enter Otp" inputStyle={style.input2} />
        <Input placeholder="Enter new password" inputStyle={style.input2} />
        <Input placeholder="Confirm new password" inputStyle={style.input2} />
        <Buttons
